          ...
          <div className="profile-wrap-container">
            ...
            <div className="professional-summary-text">
              <p style={{ marginBottom: '1rem' }}>
                I am a GeoAI and Remote Sensing Specialist with over five years of experience translating complex spatial data into scalable solutions. I apply advanced machine learning to multi-source datasets (LiDAR, multispectral, hyperspectral) and build automated image processing pipelines utilizing spatial geodatabases, algorithmic scripting, and GIS platforms. Currently, my work focuses on pioneering GeoFoundation models and advancing Earth observation through data fusion and AI-driven workflows.
              </p>
            </div>
